...
def cceua(s,sf,bl,bu,icall,maxn,iseed,OptFunction):
...
def sceua(x0,bl,bu,maxn,kstop,pcento,peps,ngs,iseed,iniflg,OptFunction):
...
##                        idx=find(lcs(1:k3-1)==lpos)
                ...
                snew,fnew,icall=cceua(s,sf,bl,bu,icall,maxn,iseed,OptFunction)
